//
//  AppDelegate.swift
//  3D-Quick-Qctions-Swift
//
//  Created by Karpis Sanosyan on 4/15/17.
//  Copyright © 2017 CryotechEnterprise. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func handleShortCutItem(shortCutItem: UIApplicationShortcutItem) -> Bool {
        ...
        case ShortcutIdentifier.SecondVC.type:
            ...
            let secVC : SecondVC = storyboard.instantiateViewController(withIdentifier: "Second") as! SecondVC
